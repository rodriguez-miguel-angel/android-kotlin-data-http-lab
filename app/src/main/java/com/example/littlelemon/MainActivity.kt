...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            LittleLemonTheme {
                /*
                step-03-01: Retrieving items from Room database
                add databaseMenuItems code here
                 */
                val databaseMenuItems by database.menuItemDao().getAll().observeAsState(initial = emptyList())
                /*
                step-04-01: Sorting by name
                add orderMenuItems variable here
                See <https://stackoverflow.com/questions/69326413/whats-difference-between-remember-and-by-remember>.
                ...
                Column(
                    ...
                    /*
                    step-04-02: Adding a search bar
                    ...
                    if(searchPhrase.isNotEmpty()) {
                        ...
                        MenuItemsList(filteredList)
                    }


                    /*
                    version-01[[step-03-02]]: Displaying list of menu items
                    MenuItemsList(databaseMenuItems)
                    version-02[[step-04-01]]: Sorting by name
